...
import (
	...
	"github.com/alexgrauroca/practice-food-delivery-platform/services/customer-service/internal/config"
	"github.com/alexgrauroca/practice-food-delivery-platform/services/customer-service/internal/log"
)

// NewClient creates and returns a new MongoDB Client with the given context and logger.
// It applies authentication if required. Returns an error if loading configuration or connecting to MongoDB fails.
