	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.expectedError == nil {
				...
				// To avoid adding the password hash logic here, we just check that the password is not equal to the original one
				assert.NotEqual(t, tt.params.Password, customer.Password, "Password should be hashed and not equal to the original one")
