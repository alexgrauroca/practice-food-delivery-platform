...
/*
LoginCustomer Login as a customer

Authenticates a customer and returns access and refresh tokens

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiLoginCustomerRequest
*/
func (a *CustomersAPIService) LoginCustomer(ctx context.Context) ApiLoginCustomerRequest {
	return ApiLoginCustomerRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CustomersAPIService) LoginCustomerExecute(r ApiLoginCustomerRequest) (*LoginCustomerResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1.0/customers/login"
...
/*
RefreshCustomer Refresh access token

Generates a new access token using a valid refresh token

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiRefreshCustomerRequest
*/
func (a *CustomersAPIService) RefreshCustomer(ctx context.Context) ApiRefreshCustomerRequest {
	return ApiRefreshCustomerRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CustomersAPIService) RefreshCustomerExecute(r ApiRefreshCustomerRequest) (*RefreshCustomerResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1.0/customers/refresh"
...
func (a *CustomersAPIService) RegisterCustomerExecute(r ApiRegisterCustomerRequest) (*RegisterCustomerResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1.0/auth/customers"
...
/*
UpdateCustomer Update a specific customer data

Returns the customer data updated. It can only be accessed by the customer itself
...
func (a *CustomersAPIService) UpdateCustomerExecute(r ApiUpdateCustomerRequest) (*Customer, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1.0/auth/customers/{customerID}"
